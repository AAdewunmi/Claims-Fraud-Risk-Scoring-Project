...
urlpatterns = [
    ...
    path("console/reviewer/", ConsolePlaceholderView.as_view(surface="reviewer"), name="console_reviewer"),
    path("console/customer/", ConsolePlaceholderView.as_view(surface="customer"), name="console_customer"),
